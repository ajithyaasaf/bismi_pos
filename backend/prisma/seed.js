...
async function main() {
    ...
    const adminPinHash = await bcryptjs_1.default.hash('1111', 10);
    const managerPasswordHash = await bcryptjs_1.default.hash('manager123', 10);
    const managerPinHash = await bcryptjs_1.default.hash('2222', 10);
    const cashierPasswordHash = await bcryptjs_1.default.hash('cashier123', 10);
    const cashierPinHash = await bcryptjs_1.default.hash('1234', 10);
    const prepPasswordHash = await bcryptjs_1.default.hash('prep123', 10);
    const prepPinHash = await bcryptjs_1.default.hash('3333', 10);
    // 3. Create Users
